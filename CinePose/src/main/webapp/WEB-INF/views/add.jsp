...
<section>
	<div class="add_form">
		<form id="addAvisForm" name="addAvisForm" method="post" action="addAvis"
			...
			<a href="javascript:toogleAddForm()"><h3 style="text-align:right">Ou ajouter un cinéma à la base de données</h3></a><br>
	...
	<div class="add_form">
		<form id="addCinemaForm" name="addCinemaForm" method="post" action="addCinema"
			...
			<a href="javascript:toogleAddForm()"><h3 style="text-align:right">Ou ajouter un Avis</h3></a><br>
...
<script>hideAddCinemaForm(); initializeAddMap();</script>
